...
screen =  np.array(ImageGrab.grab(bbox=(10,600,1280,1080))) #grab the image from computer screen at coordinates (x, y, xx, yy) , x,y = top left , xx,yy = bottom right
...
PATH_TO_CKPT = MODEL_NAME + '/output_graph.pb'

# List of the strings that is used to add correct label for each box.
PATH_TO_LABELS = os.path.join('data', 'output_labels.txt')
